...
bot = telebot.TeleBot('6396066901:AAGo_rGcdjL830a9t1WatiPjA5kk-pukcS0')

def webAppKeyboard(): #создание клавиатуры с webapp кнопкой
   keyboard = types.ReplyKeyboardMarkup(row_width=1) #создаем клавиатуру
   #webAppTest = types.WebAppInfo("https://Ramir2112.github.io") #создаем webappinfo - формат хранения url
   webAppTest = types.WebAppInfo("https://Ramir2112.github.io") #создаем webappinfo - формат хранения url
...
def webAppKeyboardInline(): #создание inline-клавиатуры с webapp кнопкой
   ...
   webApp = types.WebAppInfo("Ramir2112.github.io") #создаем webappinfo - формат хранения url
